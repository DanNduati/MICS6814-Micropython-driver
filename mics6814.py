...
#
MICS6814_I2C_ADDR = 0x19    #default i2c adress
MICS6814_VREF = 14  #3v3
MICS6814_RED = 13   #reducing
MICS6814_NH3 = 11   #NH3
MICS6814_OX = 12    #Oxidizing

MICS6814_HEATER_EN = 1  # P1.5 Heater Enable

#get chip id register test to be deleted
REG_CHIP_ID_L = 0xfa
REG_CHIP_ID_H = 0xfb
#ioe = ioexpander.IOE(i2c_addr=MICS6814_I2C_ADDR)
...
class MICS6814():
    def __init__(self,i2c,i2c_addr=MICS6814_I2C_ADDR, interrupt_timeout=1.0, interrupt_pin=None, gpio=None):
        #self._i2c = 12c
        self._ioe = io.IOE(i2c,i2c_addr, interrupt_timeout, interrupt_pin, gpio)
